...
public static ResultSetMetaData md;
 ...
 super("Mark Attendancee | Face Recognition Attendance System");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Mark Attendance");
        ...
        present.setBounds(420, 130, 370, 20);
                ...
                while (runnable) {
                    try {
                        if (webSource.grab()) {
                            ...
                            cascade.detectMultiScale(imageGray, detectedFace, 1.1, 2, 0, new Size(20, 20), new Size(500, 500));
                            ...
                            for (int i = 0; i < detectedFace.size(); i++) {
                                ...
                                opencv_imgproc.resize(faceCapturada, faceCapturada, new Size(160, 100));
                                ...
                                if (confidence.get(0) > 60.0) {
                                    rectangle(cameraImage, dadosFace, new Scalar(0, 156, 155, 3), 3, 0, 0);
                                   System.out.println(" L:H"+confidence.get(0));
                                   Double con = confidence.get(0);
                                    jLabel14.setText("Con: "+String.format("%.4f",con)+" L:H");
                                    idPerson = prediction;
                                    rec();
                                    insertDatabase();
                                    
                                    if(jLabel14.getText().trim().length() > 16){
                                    jLabel14.setText("Con: Poor");
                                    idPerson = -1;
                                    label_name.setText("");
                                    label_office.setText("");
                                    label_phone.setText("");
                                     present.setText("Try Again");
                                    }
                                }
